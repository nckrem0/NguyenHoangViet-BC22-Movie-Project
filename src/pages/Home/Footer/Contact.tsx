...
const Contact = () => {
    return (
        <div className="bg-black text-white ">
            <div className="flex py-10 justify-evenly items-center sm:flex-wrap sm:max-w-xl sm:justify-between 2xl:max-w-7xl 2xl:mx-auto xl:max-w-6xl xl:mx-auto lg:max-w-5xl lg:mx-auto lg:flex-wrap md:max-w-4xl md:mx-auto md:flex-wrap ">
                <div className="2xl:flex-1 xl:flex-1 lg:flex-none md:flex-none sm:flex-none">
